...
public class CassandraKeytoNode {
   ...
   *        https://docs.datastax.com/en/cassandra/2.1/cassandra/configuration
   *        /configGenTokens_c.html?scroll=concept_ds_rns_mt1_gk__calc-tokens-1.2
   */
  ...
  public void getHashValues() {
    ...
    try {
      ...
      for (int i = 0; i < nbKeys; i++) {
        String query = "insert into t2 (k, other) VALUES (" + i + ", 1);"; // put nbKeys keys to
                                                                           // Cassandra
  ...
  public static void main(String[] args) {
    ...
    cassandraKey2Node.connect(args[0]);
